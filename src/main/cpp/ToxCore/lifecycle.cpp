...
static void tox4j_group_message_cb(Tox *tox, int groupnumber, uint32_t peernumber, const uint8_t *message, uint16_t length, void *userdata)
{
    unused(tox);
    Events &events = *static_cast<Events *>(userdata);
...
static void tox4j_group_private_message_cb(Tox *tox, int groupnumber, uint32_t peernumber, const uint8_t *message, uint16_t length, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_action_cb(Tox *tox, int groupnumber, uint32_t peernumber, const uint8_t *message, uint16_t length, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_nick_change_cb(Tox *tox, int groupnumber, uint32_t peernumber, const uint8_t *newnick, uint16_t length, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_topic_change_cb(Tox *tox, int groupnumber, uint32_t peernumber, const uint8_t *topic, uint16_t length, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_peer_join_cb(Tox *tox, int groupnumber, uint32_t peernumber, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_peer_exit_cb(Tox *tox, int groupnumber, uint32_t peernumber, const uint8_t *partmessage, uint16_t length, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_self_join_cb(Tox *tox, int groupnumber, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_peerlist_update_cb(Tox *tox, int groupnumber, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
static void tox4j_group_self_timeout_cb(Tox *tox, int groupnumber, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
    auto msg = events.add_groupselftimeout();
    msg->set_groupnumber(groupnumber);
}

static void tox4j_group_rejected_cb(Tox *tox, int groupnumber, uint8_t type, void *user_data)
{
    unused(tox);
    Events &events = *static_cast<Events *>(user_data);
...
//    };
    ...
    return with_error_handling(env, "New", [](TOX_ERR_NEW error) {
        ...
        tox_callback_group_invite            (tox.get(), tox4j_group_invite_cb,             events.get());
        tox_callback_group_message           (tox.get(), tox4j_group_message_cb,            events.get());
        tox_callback_group_private_message   (tox.get(), tox4j_group_private_message_cb,    events.get());
        tox_callback_group_action            (tox.get(), tox4j_group_action_cb,             events.get());
        tox_callback_group_nick_change       (tox.get(), tox4j_group_nick_change_cb,        events.get());
        tox_callback_group_topic_change      (tox.get(), tox4j_group_topic_change_cb,       events.get());
        tox_callback_group_peer_join         (tox.get(), tox4j_group_peer_join_cb,          events.get());
        tox_callback_group_peer_exit         (tox.get(), tox4j_group_peer_exit_cb,          events.get());
        tox_callback_group_self_join         (tox.get(), tox4j_group_self_join_cb,          events.get());
        tox_callback_group_peer_exit         (tox.get(), tox4j_group_peer_exit_cb,          events.get());
        tox_callback_group_self_join         (tox.get(), tox4j_group_self_join_cb,          events.get());
        tox_callback_group_peerlist_update   (tox.get(), tox4j_group_peerlist_update_cb,    events.get());
        tox_callback_group_self_timeout      (tox.get(), tox4j_group_self_timeout_cb,       events.get());
        tox_callback_group_rejected          (tox.get(), tox4j_group_rejected_cb,           events.get());
