...
public class ToxAvEventAdapter implements ToxAvEventListener {
    ...
    @Override public void callState(int friendNumber, @NotNull int state) { }
    @Override public void receiveAudioFrame(int friendNumber, @NotNull short[] pcm, int channels, int samplingRate) { }
    @Override public void receiveVideoFrame(int friendNumber, int width, int height, @NotNull byte[] y, @NotNull byte[] u, @NotNull byte[] v) { }
